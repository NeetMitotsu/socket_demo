...
public class MyWebSocketHandler extends SimpleChannelInboundHandler<Object> {
    ...
    public void handlerRemoved(ChannelHandlerContext ctx) throws Exception {
        ...
        MyChannelHandlerPool.channelGroup.remove(ctx);
    }
    ...
    private void doHandlerWebSocketFrame(ChannelHandlerContext ctx, WebSocketFrame msg) {
        ...
        for (Channel channel : MyChannelHandlerPool.channelGroup) {
            channel.writeAndFlush(new TextWebSocketFrame(((TextWebSocketFrame) msg).text() +  "这是服务器回复 "));
        }
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        log.info(MyChannelHandlerPool.channelGroup.toString());
    }
}
